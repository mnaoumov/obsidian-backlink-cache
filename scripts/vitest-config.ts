...
/*
 * The performance vault is pre-populated with tens of thousands of notes before
 * open, so its setup (populate + Obsidian startup index) and the scan-at-scale
 * test both need far more time than the regular integration projects.
 */
